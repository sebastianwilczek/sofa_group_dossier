...
%% COLOR DEFINITIONS
\usepackage[svgnames,table,xcdraw]{xcolor} % Enabling mixing colors and color's call by 'svgnames'
...
%% PROJECT MANAGEMENT
\include{content/project_management}
